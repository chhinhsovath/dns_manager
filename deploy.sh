...
echo -e "\033[1;34m🔥 Ensuring port 6060 is open in firewall...\033[0m"
if command -v ufw &> /dev/null; then
  echo "testing-123" | sudo -S ufw allow 6060/tcp 2>/dev/null || echo "Firewall rule already exists"
  echo -e "\033[0;32m✓ Port 6060 is open in firewall\033[0m"
else
...
echo -e "${BLUE}  🔧 NPM Admin: http://192.168.155.122:81${NC}"
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
echo -e "${YELLOW}Services Running:${NC}"
echo "  • DNS Manager Dashboard (Port 6060) - Next.js"
echo "  • Nginx Proxy Manager (Ports 80, 443, 81) - Docker"
echo "  • PostgreSQL Database (Port 5432) - Docker"
echo ""
echo -e "${YELLOW}Next steps:${NC}"
echo "  1. Access dashboard: http://192.168.155.122:6060"
echo "  2. Configure NPM: http://192.168.155.122:81 (admin@example.com / changeme)"
