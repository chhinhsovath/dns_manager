...
if command -v ufw &> /dev/null; then
  ...
  echo "testing-123" | sudo -S ufw allow 8080/tcp 2>/dev/null || echo "Port 8080 already allowed"
  echo "testing-123" | sudo -S ufw allow 8181/tcp 2>/dev/null || echo "Port 8181 already allowed"
  echo "testing-123" | sudo -S ufw allow 8443/tcp 2>/dev/null || echo "Port 8443 already allowed"
...
echo -e "${BLUE}  🔧 NPM Admin: http://192.168.155.122:8181${NC}"
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
echo -e "${YELLOW}Services Running:${NC}"
echo "  • DNS Manager Dashboard (Port 6060) - Next.js"
echo "  • Nginx Proxy Manager (Ports 8080, 8443, 8181) - Docker"
echo "  • PostgreSQL Database (Port 5433) - Docker"
echo ""
echo -e "${YELLOW}Next steps:${NC}"
echo "  1. Access dashboard: http://192.168.155.122:6060"
echo "  2. Configure NPM: http://192.168.155.122:8181 (admin@example.com / changeme)"
